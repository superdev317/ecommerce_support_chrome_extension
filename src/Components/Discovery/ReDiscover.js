...
class ReDiscover extends React.Component {
  constructor() {
    super();
    this.state = {
      projectInfo: {},
  ...
  render() {
    ...
    return (
      <div>
        ...
        <DiscoverTable history={this.props.history} projectInfo={projectInfo} />
        <div className={classes.buttonsArea}>
          <Button variant="contained" color="default" component={Link} to={`/discover/${projectInfo.id}`}>Exit</Button>
        </div>
      </div>
    );
  }
...
export default withStyles(styles)(ReDiscover);
